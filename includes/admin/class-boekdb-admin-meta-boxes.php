...
class BoekDB_Admin_Meta_Boxes {
	...
	public function add_meta_boxes() {
		add_meta_box( 'boek_fields', 'BoekDB velden', array( __CLASS__, 'meta_boek_fields_html' ), 'boekdb_boek', 'normal',
			'high' );
	}
	...
	public static function meta_boek_fields_html( $boek ) {
		...
		$skip = array('flaptekst','annotatie','flaptekst_org','annotatie_org','recensiequotes','recensiequotes_tonen','file_voorbeeld_id','0','primair');
		echo '<table>';
