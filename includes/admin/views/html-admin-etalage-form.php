...
<table class="form-table wp-list-table widefat">
	<tbody>
	<tr>
        <th class="manage-column"><label for="etalage_name"><?php esc_html_e('Naam:', 'boekdb'); ?></label></th>
		<td><input type="text" name="etalage_name" id="etalage_name" placeholder="<?php esc_attr_e('naam', 'boekdb'); ?>" required></td>
	</tr>
	<tr>
        <th class="manage-column"><label for="etalage_api_key"><?php esc_html_e('API Key:', 'boekdb'); ?></label></th>
